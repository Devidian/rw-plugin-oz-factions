...
import de.omegazirkel.risingworld.playerfactions.FactionShopBridge;
import de.omegazirkel.risingworld.playerfactions.FactionExtra;
...
public final class FactionPluginRuntime {
    ...
    public void enable() {
        ...
        for (FactionExtra extra : FactionExtra.values()) AssetManager.loadIconFromPlugin(plugin, extra.shopOfferId());
        new FactionShopBridge(plugin, service).registerOffers();
